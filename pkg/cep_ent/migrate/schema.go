...
var (
	...
	BillsColumns = []*schema.Column{
		...
		{Name: "updated_at", Type: field.TypeTime, Comment: "更新时刻，带时区"},
		{Name: "deleted_at", Type: field.TypeTime, Comment: "软删除时刻，带时区"},
		{Name: "type", Type: field.TypeEnum, Comment: "流水的类型，对应的 order_id 关联哪张表依赖于该字段", Enums: []string{"withdraw", "unknown", "recharge", "mission_consume", "mission_produce", "transfer", "active", "mission", "special_mission", "gas", "extra_service", "cdk", "lotto", "node_trouble", "income_manage", "illegal", "survey", "compensate", "invoke_model_order", "subsidy"}, Default: "unknown"},
		{Name: "way", Type: field.TypeEnum, Comment: "额度账户流水的产生方式，微信、支付宝、计时消耗等，偏向于业务展示", Enums: []string{"withdraw_bank_card", "withdraw_alipay", "withdraw_wechat", "withdraw_refund", "withdraw_company", "unknown", "recharge_wechat", "recharge_alipay", "recharge_tron", "mission_time", "mission_time_plan_hour", "mission_time_plan_day", "mission_time_plan_week", "mission_time_plan_month", "mission_count", "active_bind", "mission_hold", "mission_volume", "active_register", "active_share", "active_recharge", "transfer_manual", "first_invite_recharge", "transfer_withdraw", "special_channel_recharge", "extra_service_time_plan_hour", "extra_service_time_plan_day", "extra_service_time_plan_week", "extra_service_time_plan_month", "extra_service_hold", "extra_service_volume", "active_invite_recharge", "active_channel_recharge", "extra_service_time", "cdk_exchange", "lotto_prize", "node_trouble", "income_replacement", "income_deduct", "illegal_invite", "survey_submit", "compensate_mission_recover_failed", "invoked_model", "night_subsidy"}, Default: "unknown"},
	...
	DevicesColumns = []*schema.Column{
		...
		{Name: "fault", Type: field.TypeEnum, Comment: "故障信息", Enums: []string{"ok", "drive_abnormal", "no_disk", "task_failure", "recover", "high_temperature", "disk_write_failed", "gpu_not_match"}, Default: "ok"},
		...
		{Name: "last_abnormal_at", Type: field.TypeTime, Nullable: true, Comment: "最后一次异常时刻，带时区（用于设备稳定性升级）"},
	...
	DevicesTable = &schema.Table{
		...
		ForeignKeys: []*schema.ForeignKey{
			...
			},
			{
				...
				Columns:    []*schema.Column{DevicesColumns[35]},
				RefColumns: []*schema.Column{UsersColumns[0]},
				OnDelete:   schema.NoAction,
			},
		},
	...
	InvokeModelOrdersColumns = []*schema.Column{
		...
		{Name: "input_cep_cost", Type: field.TypeInt64, Comment: "输入cep消耗", Default: 0},
		{Name: "output_cep_cost", Type: field.TypeInt64, Comment: "输出cep消耗", Default: 0},
	...
	MissionsColumns = []*schema.Column{
		...
		{Name: "status", Type: field.TypeEnum, Comment: "任务状态", Enums: []string{"waiting", "canceled", "doing", "supplying", "closing", "done", "paused", "resuming"}, Default: "waiting"},
		{Name: "result", Type: field.TypeEnum, Comment: "任务结果，pending 表示还没有结果", Enums: []string{"pending", "succeed", "failed"}, Default: "pending"},
		{Name: "state", Type: field.TypeEnum, Comment: "新任务状态，整合原状态和结果", Enums: []string{"unknown", "waiting", "canceled", "doing", "supplying", "closing", "succeed", "failed", "paused", "resuming"}, Default: "unknown"},
		...
		{Name: "create_way", Type: field.TypeEnum, Comment: "任务创建方式，user：用户自己通过官网页面创建，load_balance：用户通过创建 Loadbalance 自动创建", Enums: []string{"unknown", "user", "load_balance"}, Default: "unknown"},
		...
		{Name: "timed_shutdown", Type: field.TypeTime, Nullable: true, Comment: "任务定时关机时间"},
		{Name: "gpu_num", Type: field.TypeInt, Comment: "多GPU支持,使用GPU数量", Default: 1},
	...
	MissionsTable = &schema.Table{
		...
		ForeignKeys: []*schema.ForeignKey{
			...
			},
			{
				...
				Columns:    []*schema.Column{MissionsColumns[45]},
				RefColumns: []*schema.Column{MissionBatchesColumns[0]},
				OnDelete:   schema.NoAction,
			},
			{
				Symbol:     "missions_mission_kinds_missions",
				Columns:    []*schema.Column{MissionsColumns[46]},
				RefColumns: []*schema.Column{MissionKindsColumns[0]},
				OnDelete:   schema.NoAction,
			},
			{
				Symbol:     "missions_users_missions",
				Columns:    []*schema.Column{MissionsColumns[47]},
				RefColumns: []*schema.Column{UsersColumns[0]},
				OnDelete:   schema.NoAction,
			},
		},
	...
	MissionConsumeOrdersColumns = []*schema.Column{
		...
		{Name: "updated_at", Type: field.TypeTime, Comment: "更新时刻，带时区"},
		{Name: "deleted_at", Type: field.TypeTime, Comment: "软删除时刻，带时区"},
		{Name: "status", Type: field.TypeEnum, Comment: "任务订单的状态，注意不强关联任务的状态", Enums: []string{"unknown", "waiting", "canceled", "doing", "supplying", "failed", "succeed", "paused"}, Default: "unknown"},
	...
	MissionFailedFeedbacksColumns = []*schema.Column{
		...
		{Name: "updated_at", Type: field.TypeTime, Comment: "更新时刻，带时区"},
		{Name: "deleted_at", Type: field.TypeTime, Comment: "软删除时刻，带时区"},
		{Name: "type", Type: field.TypeEnum, Comment: "任务失败反馈类型", Enums: []string{"unknown", "start", "recover"}, Default: "unknown"},
	...
	MissionFailedFeedbacksTable = &schema.Table{
		...
		ForeignKeys: []*schema.ForeignKey{
			...
			},
			{
				...
				Columns:    []*schema.Column{MissionFailedFeedbacksColumns[12]},
				RefColumns: []*schema.Column{UsersColumns[0]},
				OnDelete:   schema.NoAction,
			},
		},
		Indexes: []*schema.Index{
			...
			},
			{
				...
				Unique:  false,
				Columns: []*schema.Column{MissionFailedFeedbacksColumns[12], MissionFailedFeedbacksColumns[11]},
			},
		},
	}
	...
	MissionKindsColumns = []*schema.Column{
		...
		{Name: "category", Type: field.TypeEnum, Comment: "任务大类", Enums: []string{"unknown", "SD", "JP", "JP_Qinglong", "WT", "JP_DK", "SSH", "SGLANG", "SD_TOMATO", "SD_CMD", "SD_TIAN", "SD_BINGO", "FOOOCUS", "FOOOCUS_LAN_QUE", "FOOOCUS_SHA_API", "TABBY", "OLLAMA", "JP_CONDA", "SD_CAT", "SD_FIRE", "COMFYUI", "SD_XL", "SD_CHICK", "ASCEND", "SD_WU_SHAN", "SD_LANG", "SD_ZHI_DAO", "COMFYUI_KE", "COMFYUI_A_SHUO", "COMFYUI_JIA_MING", "CHATCHAT", "CHATTTS", "LORA", "LORA_FLUX_GYM", "FOOOCUS_WU", "SVD_BACK", "SD_JI", "SD_SHANG_JIN", "SD_XIAO_CHUN", "COMFYUI_WU", "COMFYUI_LIU", "SD_QKK", "COMFYUI_LI", "COMFYUI_NENLY", "COMFYUI_OU", "COMFYUI_LU", "COMFYUI_JIANG", "COMFYUI_STAR", "WAITING", "WAITING_AL", "OPEN_CL", "IO_PAINT"}, Default: "unknown"},
	...
	MissionLoadBalancesColumns = []*schema.Column{
		...
		{Name: "state", Type: field.TypeEnum, Comment: "mission 负载均衡总状态", Enums: []string{"unknown", "waiting", "canceled", "doing", "supplying", "closing", "succeed", "failed", "paused", "resuming", "contracting", "expanding", "recovering"}, Default: "unknown"},
		{Name: "started_at", Type: field.TypeTime, Comment: "任务开始时刻"},
		{Name: "finished_at", Type: field.TypeTime, Comment: "任务完成时刻"},
	...
	MissionProduceOrdersColumns = []*schema.Column{
		...
		{Name: "status", Type: field.TypeEnum, Comment: "任务订单的状态，注意不强关联任务的状态", Enums: []string{"unknown", "waiting", "canceled", "doing", "supplying", "failed", "succeed", "paused"}, Default: "waiting"},
	...
	MissionProductionsColumns = []*schema.Column{
		...
		{Name: "started_at", Type: field.TypeTime, Comment: "任务开始时刻"},
		{Name: "finished_at", Type: field.TypeTime, Comment: "任务完成时刻"},
		{Name: "state", Type: field.TypeEnum, Comment: "任务执行状态情况", Enums: []string{"unknown", "waiting", "canceled", "doing", "supplying", "closing", "succeed", "failed", "paused", "resuming"}, Default: "unknown"},
		{Name: "gpu_version", Type: field.TypeEnum, Comment: "任务使用什么显卡在执行", Enums: []string{"unknown", "RTX2060", "RTX2060Ti", "RTX2070", "RTX2070Ti", "RTX2080", "RTX2080Ti", "RTX3060", "RTX3060Ti", "RTX3070", "RTX3070Ti", "RTX3080", "RTX3080Ti", "RTX3090", "RTX3090Ti", "RTX4060", "RTX4060Ti", "RTX4070", "RTX4070Ti", "RTX4080", "RTX4090", "RTX4090D", "A800", "A100", "V100", "ComputilityKing-I", "Ascend910ProB", "P40"}, Default: "unknown"},
		{Name: "device_slot", Type: field.TypeInt8, Comment: "显卡占用设备的插槽", Default: 0},
		{Name: "urls", Type: field.TypeString, Comment: "任务结果链接列表，json 序列化后存储", Default: ""},
		{Name: "resp_status_code", Type: field.TypeInt32, Comment: "内部功能返回码", Default: 0},
		{Name: "resp_body", Type: field.TypeString, Comment: "返回内容体 json 转 string", Default: ""},
		{Name: "device_slots", Type: field.TypeString, Comment: "显卡占用设备的插槽(多gpu)", Default: ""},
		{Name: "gpu_num", Type: field.TypeInt8, Comment: "使用显卡数量", Default: 0},
		{Name: "device_id", Type: field.TypeInt64, Comment: "领到任务的设备 ID", Default: 0},
		{Name: "mission_id", Type: field.TypeInt64, Comment: "任务 ID"},
		{Name: "user_id", Type: field.TypeInt64, Comment: "用户 ID"},
	...
	MissionProductionsTable = &schema.Table{
		...
		ForeignKeys: []*schema.ForeignKey{
			...
			},
			{
				...
				Columns:    []*schema.Column{MissionProductionsColumns[17]},
				RefColumns: []*schema.Column{MissionsColumns[0]},
				OnDelete:   schema.NoAction,
			},
			{
				Symbol:     "mission_productions_users_mission_productions",
				Columns:    []*schema.Column{MissionProductionsColumns[18]},
				RefColumns: []*schema.Column{UsersColumns[0]},
				OnDelete:   schema.NoAction,
			},
		},
	...
	PricesColumns = []*schema.Column{
		...
		{Name: "mission_type", Type: field.TypeEnum, Comment: "任务类型", Enums: []string{"unknown", "sd_time", "sd_pro_time", "txt2img", "img2img", "jp_time", "jp_qinglong_time", "jp_qinglong_time_plan", "wt_time", "extra-single-image", "sd_api", "key_pair", "jp_dk_time", "ssh_time", "sglang_time", "sd_time_plan", "sd_pro_time_plan", "wt_time_plan", "jp_time_plan", "jp_dk_time_plan", "ssh_time_plan", "sglang_time_plan", "sd_tomato_time", "sd_tomato_time_plan", "sd_cmd_time", "sd_cmd_time_plan", "sd_tian_time", "sd_tian_time_plan", "sd_bingo_time", "sd_bingo_time_plan", "fooocus_time", "fooocus_time_plan", "fooocus_lan_que_time", "fooocus_lan_que_time_plan", "fooocus_sha_api_time", "fooocus_sha_api_time_plan", "tabby_time", "tabby_time_plan", "ollama_time", "ollama_time_plan", "jp_conda_time", "jp_conda_time_plan", "jp_ml_time", "jp_ml_time_plan", "sd_cat_time", "sd_cat_time_plan", "sd_fire_time", "sd_fire_time_plan", "comfyui_time", "comfyui_time_plan", "comfyui_pro_time", "comfyui_pro_time_plan", "comfyui_advance_time", "comfyui_advance_time_plan", "jp_dk_3_time", "jp_dk_3_time_plan", "sd_xl_time", "sd_xl_time_plan", "sd_chick_time", "sd_chick_time_plan", "ascend_time", "ascend_time_plan", "sd_wu_shan_time", "sd_wu_shan_time_plan", "sd_lang_time", "sd_lang_time_plan", "sd_zhi_dao_time", "sd_zhi_dao_time_plan", "comfyui_ke_time", "comfyui_ke_time_plan", "comfyui_a_shuo_time", "comfyui_a_shuo_time_plan", "comfyui_jia_ming_time", "comfyui_jia_ming_time_plan", "chatchat_time", "chatchat_time_plan", "chat_tts_time", "chat_tts_time_plan", "lora_time", "lora_time_plan", "lora_flux_time", "lora_flux_time_plan", "lora_flux_gym_time", "lora_flux_gym_time_plan", "fooocus_wu_time", "fooocus_wu_time_plan", "svd_back_time", "svd_back_time_plan", "sd_ji_time", "sd_ji_time_plan", "sd_shang_jin_time", "sd_shang_jin_time_plan", "sd_xiao_chun_time", "sd_xiao_chun_time_plan", "comfyui_wu_time", "comfyui_wu_time_plan", "comfyui_liu_time", "comfyui_liu_time_plan", "sd_qkk_time", "sd_qkk_time_plan", "comfyui_li_time", "comfyui_li_time_plan", "comfyui_nenly_time", "comfyui_nenly_time_plan", "comfyui_ou_time", "comfyui_ou_time_plan", "comfyui_lu_time", "comfyui_lu_time_plan", "comfyui_jiang_time", "comfyui_jiang_time_plan", "comfyui_star_time", "comfyui_star_time_plan", "waiting_time", "waiting_time_plan", "waiting_al_time", "waiting_al_time_plan", "opencl_core_time", "opencl_core_time_plan", "io_paint_time", "io_paint_time_plan"}, Default: "txt2img"},
		{Name: "mission_category", Type: field.TypeEnum, Comment: "任务大类", Enums: []string{"unknown", "SD", "JP", "JP_Qinglong", "WT", "JP_DK", "SSH", "SGLANG", "SD_TOMATO", "SD_CMD", "SD_TIAN", "SD_BINGO", "FOOOCUS", "FOOOCUS_LAN_QUE", "FOOOCUS_SHA_API", "TABBY", "OLLAMA", "JP_CONDA", "SD_CAT", "SD_FIRE", "COMFYUI", "SD_XL", "SD_CHICK", "ASCEND", "SD_WU_SHAN", "SD_LANG", "SD_ZHI_DAO", "COMFYUI_KE", "COMFYUI_A_SHUO", "COMFYUI_JIA_MING", "CHATCHAT", "CHATTTS", "LORA", "LORA_FLUX_GYM", "FOOOCUS_WU", "SVD_BACK", "SD_JI", "SD_SHANG_JIN", "SD_XIAO_CHUN", "COMFYUI_WU", "COMFYUI_LIU", "SD_QKK", "COMFYUI_LI", "COMFYUI_NENLY", "COMFYUI_OU", "COMFYUI_LU", "COMFYUI_JIANG", "COMFYUI_STAR", "WAITING", "WAITING_AL", "OPEN_CL", "IO_PAINT"}, Default: "SD"},
	...
	RechargeCampaignRuleOverseasColumns = []*schema.Column{
		...
		{Name: "updated_at", Type: field.TypeTime, Comment: "更新时刻，带时区"},
		{Name: "deleted_at", Type: field.TypeTime, Comment: "软删除时刻，带时区"},
		{Name: "dollar_price", Type: field.TypeString, Comment: "美元价格，为了大数计算，都用字符串存", Default: "0"},
		{Name: "rmb_price", Type: field.TypeString, Comment: "RMB 价格", Default: "0"},
		{Name: "original_rmb_price", Type: field.TypeString, Comment: "RMB 原价", Default: "0"},
	...
	TransferOrdersColumns = []*schema.Column{
		...
		{Name: "third_api_resp", Type: field.TypeString, Comment: "第三方平台的返回，给到前端才能发起支付", Default: ""},
		{Name: "out_transaction_id", Type: field.TypeString, Comment: "平台方订单号", Default: ""},
		{Name: "operate_user_id", Type: field.TypeInt64, Comment: "操作的用户 id，管理后台手动充值才有数据，默认为 0", Default: 0},
		{Name: "gift_type", Type: field.TypeEnum, Comment: "充值订单活动赠送的类型", Enums: []string{"no", "register", "survey"}, Default: "no"},
		{Name: "symbol_id", Type: field.TypeInt64, Comment: "币种 id", Default: 0},
	...
	UsersColumns = []*schema.Column{
		...
		{Name: "user_type", Type: field.TypeEnum, Comment: "用户类型", Enums: []string{"personal", "enterprise", "admin", "boss", "admin_read_only", "opencl"}, Default: "personal"},
