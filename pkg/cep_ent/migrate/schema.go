...
var (
	...
	BillsColumns = []*schema.Column{
		...
		{Name: "updated_at", Type: field.TypeTime, Comment: "更新时刻，带时区"},
		{Name: "deleted_at", Type: field.TypeTime, Comment: "软删除时刻，带时区"},
		{Name: "type", Type: field.TypeEnum, Comment: "流水的类型，对应的 order_id 关联哪张表依赖于该字段", Enums: []string{"withdraw", "unknown", "recharge", "mission_consume", "mission_produce", "transfer", "active", "mission", "gas", "extra_service", "cdk", "lotto", "node_trouble", "income_manage", "illegal", "survey", "compensate", "invoke_model_order"}, Default: "unknown"},
