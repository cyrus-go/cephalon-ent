...
var (
	...
	MissionsColumns = []*schema.Column{
		...
		{Name: "updated_at", Type: field.TypeTime},
		{Name: "deleted_at", Type: field.TypeTime},
		{Name: "type", Type: field.TypeEnum, Comment: "任务类型", Enums: []string{"unknown", "sd_time", "txt2img", "img2img", "jp_time", "wt_time", "extra-single-image", "sd_api", "key_pair", "jp_dk_time", "ssh_time", "sd_time_plan_hour", "sd_time_plan_day", "sd_time_plan_week", "sd_time_plan_month"}, Default: "unknown"},
	...
	MissionConsumeOrdersColumns = []*schema.Column{
		...
		{Name: "type", Type: field.TypeEnum, Comment: "任务类型，等于任务表的类型字段", Enums: []string{"unknown", "sd_time", "txt2img", "img2img", "jp_time", "wt_time", "extra-single-image", "sd_api", "key_pair", "jp_dk_time", "ssh_time", "sd_time_plan_hour", "sd_time_plan_day", "sd_time_plan_week", "sd_time_plan_month"}, Default: "unknown"},
	...
	MissionKindsColumns = []*schema.Column{
		...
		{Name: "updated_at", Type: field.TypeTime},
		{Name: "deleted_at", Type: field.TypeTime},
		{Name: "type", Type: field.TypeEnum, Comment: "任务单位类型", Enums: []string{"unknown", "sd_time", "txt2img", "img2img", "jp_time", "wt_time", "extra-single-image", "sd_api", "key_pair", "jp_dk_time", "ssh_time", "sd_time_plan_hour", "sd_time_plan_day", "sd_time_plan_week", "sd_time_plan_month"}, Default: "unknown"},
	...
	MissionOrdersColumns = []*schema.Column{
		...
		{Name: "mission_type", Type: field.TypeEnum, Comment: "任务类型，等于任务表的类型字段", Enums: []string{"unknown", "sd_time", "txt2img", "img2img", "jp_time", "wt_time", "extra-single-image", "sd_api", "key_pair", "jp_dk_time", "ssh_time", "sd_time_plan_hour", "sd_time_plan_day", "sd_time_plan_week", "sd_time_plan_month"}, Default: "unknown"},
	...
	MissionProduceOrdersColumns = []*schema.Column{
		...
		{Name: "type", Type: field.TypeEnum, Comment: "任务类型，计时或者次数任务", Enums: []string{"unknown", "sd_time", "txt2img", "img2img", "jp_time", "wt_time", "extra-single-image", "sd_api", "key_pair", "jp_dk_time", "ssh_time", "sd_time_plan_hour", "sd_time_plan_day", "sd_time_plan_week", "sd_time_plan_month"}, Default: "unknown"},
		{Name: "is_time", Type: field.TypeBool, Comment: "是否为计时类型任务", Default: false},
		{Name: "serial_number", Type: field.TypeString, Comment: "订单序列号", Default: ""},
	...
	PricesColumns = []*schema.Column{
		...
		{Name: "mission_type", Type: field.TypeEnum, Comment: "任务类型", Enums: []string{"unknown", "sd_time", "txt2img", "img2img", "jp_time", "wt_time", "extra-single-image", "sd_api", "key_pair", "jp_dk_time", "ssh_time", "sd_time_plan_hour", "sd_time_plan_day", "sd_time_plan_week", "sd_time_plan_month"}, Default: "txt2img"},
