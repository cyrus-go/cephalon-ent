...
func MissionCategoryValidator(mc enums.MissionCategory) error {
	switch mc {
	case "unknown", "SD", "JP", "WT", "JP_DK", "SSH", "SD_TOMATO", "SD_CMD", "SD_TIAN", "SD_BINGO", "FOOOCUS", "FOOOCUS_LAN_QUE", "TABBY", "JP_CONDA", "SD_CAT", "SD_FIRE", "COMFYUI", "SD_XL", "SD_CHICK", "ASCEND", "SD_WU_SHAN", "SD_LANG", "COMFYUI_KE", "CHATCHAT", "LORA", "FOOOCUS_WU", "SVD_BACK", "SD_JI", "SD_SHANG_JIN", "SD_XIAO_CHUN", "COMFYUI_WU", "COMFYUI_LIU", "WAITING":
		return nil
	default:
