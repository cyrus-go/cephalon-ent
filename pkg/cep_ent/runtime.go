...
func init() {
	...
	// extraserviceorderDescMissionOrderID is the schema descriptor for mission_order_id field.
	extraserviceorderDescMissionOrderID := extraserviceorderFields[1].Descriptor()
	...
	gpu.DefaultLowestEarnMonth = gpuDescLowestEarnMonth.Default.(int64)
	// gpuDescHighestEarnMonth is the schema descriptor for highest_earn_month field.
	...
	invokemodelorderMixin := schema.InvokeModelOrder{}.Mixin()
	invokemodelorderMixinFields0 := invokemodelorderMixin[0].Fields()
	_ = invokemodelorderMixinFields0
	invokemodelorderFields := schema.InvokeModelOrder{}.Fields()
	_ = invokemodelorderFields
	// invokemodelorderDescCreatedBy is the schema descriptor for created_by field.
	invokemodelorderDescCreatedBy := invokemodelorderMixinFields0[1].Descriptor()
	// invokemodelorder.DefaultCreatedBy holds the default value on creation for the created_by field.
	invokemodelorder.DefaultCreatedBy = invokemodelorderDescCreatedBy.Default.(int64)
	// invokemodelorderDescUpdatedBy is the schema descriptor for updated_by field.
	invokemodelorderDescUpdatedBy := invokemodelorderMixinFields0[2].Descriptor()
	// invokemodelorder.DefaultUpdatedBy holds the default value on creation for the updated_by field.
	invokemodelorder.DefaultUpdatedBy = invokemodelorderDescUpdatedBy.Default.(int64)
	// invokemodelorderDescCreatedAt is the schema descriptor for created_at field.
	invokemodelorderDescCreatedAt := invokemodelorderMixinFields0[3].Descriptor()
	// invokemodelorder.DefaultCreatedAt holds the default value on creation for the created_at field.
	invokemodelorder.DefaultCreatedAt = invokemodelorderDescCreatedAt.Default.(func() time.Time)
	// invokemodelorderDescUpdatedAt is the schema descriptor for updated_at field.
	invokemodelorderDescUpdatedAt := invokemodelorderMixinFields0[4].Descriptor()
	// invokemodelorder.DefaultUpdatedAt holds the default value on creation for the updated_at field.
	invokemodelorder.DefaultUpdatedAt = invokemodelorderDescUpdatedAt.Default.(func() time.Time)
	// invokemodelorder.UpdateDefaultUpdatedAt holds the default value on update for the updated_at field.
	invokemodelorder.UpdateDefaultUpdatedAt = invokemodelorderDescUpdatedAt.UpdateDefault.(func() time.Time)
	// invokemodelorderDescDeletedAt is the schema descriptor for deleted_at field.
	invokemodelorderDescDeletedAt := invokemodelorderMixinFields0[5].Descriptor()
	...
	invokemodelorder.DefaultID = invokemodelorderDescID.Default.(func() int64)
	...
	missionfailedfeedbackDescMissionName := missionfailedfeedbackFields[4].Descriptor()
	...
	missionfailedfeedbackDescReason := missionfailedfeedbackFields[6].Descriptor()
	...
	transferorderDescOperateUserID := transferorderFields[10].Descriptor()
	...
	// walletDescTotalAmount is the schema descriptor for total_amount field.
	walletDescTotalAmount := walletFields[3].Descriptor()
	// wallet.DefaultTotalAmount holds the default value on creation for the total_amount field.
	wallet.DefaultTotalAmount = walletDescTotalAmount.Default.(int64)
	// walletDescWithdrawAmount is the schema descriptor for withdraw_amount field.
	walletDescWithdrawAmount := walletFields[4].Descriptor()
	...
	withdrawaccountDescBusinessID := withdrawaccountFields[2].Descriptor()
	...
	// withdrawaccountDescIDCard is the schema descriptor for id_card field.
	withdrawaccountDescIDCard := withdrawaccountFields[4].Descriptor()
	// withdrawaccount.DefaultIDCard holds the default value on creation for the id_card field.
	withdrawaccount.DefaultIDCard = withdrawaccountDescIDCard.Default.(string)
	// withdrawaccountDescPersonalName is the schema descriptor for personal_name field.
	withdrawaccountDescPersonalName := withdrawaccountFields[5].Descriptor()
	...
	withdrawaccountDescPhone := withdrawaccountFields[6].Descriptor()
	...
	withdrawaccountDescBankCardNumber := withdrawaccountFields[7].Descriptor()
	...
	withdrawaccountDescBank := withdrawaccountFields[8].Descriptor()
	...
	// withdrawaccountDescAlipayCardNo is the schema descriptor for alipay_card_no field.
	...
	withdrawrecordMixin := schema.WithdrawRecord{}.Mixin()
	withdrawrecordMixinFields0 := withdrawrecordMixin[0].Fields()
	_ = withdrawrecordMixinFields0
	withdrawrecordFields := schema.WithdrawRecord{}.Fields()
	_ = withdrawrecordFields
	// withdrawrecordDescCreatedBy is the schema descriptor for created_by field.
	withdrawrecordDescCreatedBy := withdrawrecordMixinFields0[1].Descriptor()
	// withdrawrecord.DefaultCreatedBy holds the default value on creation for the created_by field.
	withdrawrecord.DefaultCreatedBy = withdrawrecordDescCreatedBy.Default.(int64)
	// withdrawrecordDescUpdatedBy is the schema descriptor for updated_by field.
	withdrawrecordDescUpdatedBy := withdrawrecordMixinFields0[2].Descriptor()
	// withdrawrecord.DefaultUpdatedBy holds the default value on creation for the updated_by field.
	withdrawrecord.DefaultUpdatedBy = withdrawrecordDescUpdatedBy.Default.(int64)
	// withdrawrecordDescCreatedAt is the schema descriptor for created_at field.
	withdrawrecordDescCreatedAt := withdrawrecordMixinFields0[3].Descriptor()
	// withdrawrecord.DefaultCreatedAt holds the default value on creation for the created_at field.
	withdrawrecord.DefaultCreatedAt = withdrawrecordDescCreatedAt.Default.(func() time.Time)
	// withdrawrecordDescUpdatedAt is the schema descriptor for updated_at field.
	withdrawrecordDescUpdatedAt := withdrawrecordMixinFields0[4].Descriptor()
	// withdrawrecord.DefaultUpdatedAt holds the default value on creation for the updated_at field.
	withdrawrecord.DefaultUpdatedAt = withdrawrecordDescUpdatedAt.Default.(func() time.Time)
	// withdrawrecord.UpdateDefaultUpdatedAt holds the default value on update for the updated_at field.
	withdrawrecord.UpdateDefaultUpdatedAt = withdrawrecordDescUpdatedAt.UpdateDefault.(func() time.Time)
	// withdrawrecordDescDeletedAt is the schema descriptor for deleted_at field.
	withdrawrecordDescDeletedAt := withdrawrecordMixinFields0[5].Descriptor()
	// withdrawrecord.DefaultDeletedAt holds the default value on creation for the deleted_at field.
	withdrawrecord.DefaultDeletedAt = withdrawrecordDescDeletedAt.Default.(time.Time)
	// withdrawrecordDescUserID is the schema descriptor for user_id field.
	withdrawrecordDescUserID := withdrawrecordFields[0].Descriptor()
	// withdrawrecord.DefaultUserID holds the default value on creation for the user_id field.
	withdrawrecord.DefaultUserID = withdrawrecordDescUserID.Default.(int64)
	// withdrawrecordDescWithdrawAccount is the schema descriptor for withdraw_account field.
	...
	withdrawrecord.DefaultID = withdrawrecordDescID.Default.(func() int64)
}
