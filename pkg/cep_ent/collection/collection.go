...
const (
	...
	FieldUserID = "user_id"
	// FieldPictureName holds the string denoting the picture_name field in the database.
	FieldPictureName = "picture_name"
...
var (
	...
	DefaultUserID int64
	// DefaultPictureName holds the default value on creation for the "picture_name" field.
...
// ByPictureName orders the results by the picture_name field.
func ByPictureName(opts ...sql.OrderTermOption) OrderOption {
	return sql.OrderByField(FieldPictureName, opts...).ToFunc()
}
