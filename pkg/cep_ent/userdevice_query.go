...
func (udq *UserDeviceQuery) QueryDevice() *DeviceQuery {
	query := (&DeviceClient{config: udq.config}).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := udq.prepareQuery(ctx); err != nil {
			return nil, err
		}
...
func (udq *UserDeviceQuery) FirstID(ctx context.Context) (id int64, err error) {
	var ids []int64
...
func (udq *UserDeviceQuery) FirstIDX(ctx context.Context) int64 {
...
func (udq *UserDeviceQuery) OnlyID(ctx context.Context) (id int64, err error) {
	var ids []int64
...
func (udq *UserDeviceQuery) OnlyIDX(ctx context.Context) int64 {
...
func (udq *UserDeviceQuery) IDs(ctx context.Context) (ids []int64, err error) {
...
func (udq *UserDeviceQuery) IDsX(ctx context.Context) []int64 {
	ids, err := udq.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (udq *UserDeviceQuery) Clone() *UserDeviceQuery {
	...
	return &UserDeviceQuery{
		...
		withDevice: udq.withDevice.Clone(),
...
func (udq *UserDeviceQuery) WithDevice(opts ...func(*DeviceQuery)) *UserDeviceQuery {
	query := (&DeviceClient{config: udq.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	udq.withDevice = query
	return udq
}
...
func (udq *UserDeviceQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*UserDevice, error) {
	...
	if query := udq.withDevice; query != nil {
		if err := udq.loadDevice(ctx, query, nodes, nil,
			func(n *UserDevice, e *Device) { n.Edges.Device = e }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (udq *UserDeviceQuery) loadDevice(ctx context.Context, query *DeviceQuery, nodes []*UserDevice, init func(*UserDevice), assign func(*UserDevice, *Device)) error {
	ids := make([]int64, 0, len(nodes))
	nodeids := make(map[int64][]*UserDevice)
	for i := range nodes {
		fk := nodes[i].DeviceID
