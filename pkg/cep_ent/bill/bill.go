...
func TypeValidator(_type enums.BillType) error {
	switch _type {
	case "withdraw", "unknown", "recharge", "mission_consume", "mission_produce", "transfer", "active", "mission", "gas", "extra_service", "cdk", "lotto":
		return nil
	default:
