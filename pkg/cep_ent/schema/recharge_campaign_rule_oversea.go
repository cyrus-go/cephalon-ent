...
func (RechargeCampaignRuleOversea) Fields() []ent.Field {
	return []ent.Field{
		field.String("dollar_price").Default("0").StructTag(`json:"dollar_price"`).Comment("美元价格，为了大数计算，都用字符串存"),
		field.String("rmb_price").Default("0").StructTag(`json:"rmb_price"`).Comment("RMB 价格"),
		field.String("original_rmb_price").Default("0").StructTag(`json:"original_rmb_price"`).Comment("RMB 原价"),
