...
const (
	// Label holds the string label denoting the devicestate type in the database.
	Label = "device_state"
	...
	EdgeDevice = "device"
	// Table holds the table name of the devicestate in the database.
	Table = "device_states"
	// DeviceTable is the table that holds the device relation/edge.
	DeviceTable = "device_states"
...
// Columns holds all SQL columns for devicestate fields.
var Columns = []string{
	FieldID,
	FieldCreatedBy,
	FieldUpdatedBy,
...
// OrderOption defines the ordering options for the DeviceState queries.
