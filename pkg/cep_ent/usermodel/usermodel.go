...
const DefaultRelation enums.UserModelRelation = "unknown"

// RelationValidator is a validator for the "relation" field enum values. It is called by the builders before save.
func RelationValidator(r enums.UserModelRelation) error {
	switch r {
	case "star", "used", "unknown":
		return nil
	default:
		return fmt.Errorf("usermodel: invalid enum value for relation field: %q", r)
	}
}

const DefaultStatus enums.UserModelRelationStatus = "unknown"

// StatusValidator is a validator for the "status" field enum values. It is called by the builders before save.
func StatusValidator(s enums.UserModelRelationStatus) error {
	switch s {
	case "unknown", "star", "unstar", "used":
		return nil
	default:
		return fmt.Errorf("usermodel: invalid enum value for status field: %q", s)
	}
}
