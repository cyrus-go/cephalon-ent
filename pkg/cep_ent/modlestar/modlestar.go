...
const (
	// Label holds the string label denoting the modlestar type in the database.
	Label = "modle_star"
	...
	EdgeModel = "model"
	// Table holds the table name of the modlestar in the database.
	Table = "modle_stars"
	// UserTable is the table that holds the user relation/edge.
	UserTable = "modle_stars"
...
// Columns holds all SQL columns for modlestar fields.
var Columns = []string{
	FieldID,
	FieldCreatedBy,
	FieldUpdatedBy,
...
func StatusValidator(s enums.Model) error {
	...
	case "unknown", "language":
		return nil
	default:
		return fmt.Errorf("modlestar: invalid enum value for status field: %q", s)
	}
}

// OrderOption defines the ordering options for the ModleStar queries.
