...
func TypeValidator(_type enums.TransferOrderType) error {
	switch _type {
	case "withdraw_vx", "withdraw_alipay", "withdraw_bank_card", "unknown", "recharge", "recharge_vx", "recharge_alipay", "recharge_trx", "manual", "withdraw", "recharge_refund", "withdraw_company":
		return nil
	default:
