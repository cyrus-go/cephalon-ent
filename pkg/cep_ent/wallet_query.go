...
func (wq *WalletQuery) QueryBills() *BillQuery {
	query := (&BillClient{config: wq.config}).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := wq.prepareQuery(ctx); err != nil {
			return nil, err
		}
...
func (wq *WalletQuery) FirstID(ctx context.Context) (id int64, err error) {
	var ids []int64
...
func (wq *WalletQuery) FirstIDX(ctx context.Context) int64 {
...
func (wq *WalletQuery) OnlyID(ctx context.Context) (id int64, err error) {
	var ids []int64
...
func (wq *WalletQuery) OnlyIDX(ctx context.Context) int64 {
...
func (wq *WalletQuery) IDs(ctx context.Context) (ids []int64, err error) {
...
func (wq *WalletQuery) IDsX(ctx context.Context) []int64 {
	ids, err := wq.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (wq *WalletQuery) WithBills(opts ...func(*BillQuery)) *WalletQuery {
	query := (&BillClient{config: wq.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (wq *WalletQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Wallet, error) {
	...
	if query := wq.withBills; query != nil {
		if err := wq.loadBills(ctx, query, nodes,
			func(n *Wallet) { n.Edges.Bills = []*Bill{} },
			func(n *Wallet, e *Bill) { n.Edges.Bills = append(n.Edges.Bills, e) }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (wq *WalletQuery) loadBills(ctx context.Context, query *BillQuery, nodes []*Wallet, init func(*Wallet), assign func(*Wallet, *Bill)) error {
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(bill.FieldWalletID)
	}
	query.Where(predicate.Bill(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(wallet.BillsColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
