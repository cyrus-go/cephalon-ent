...
func (uq *UserQuery) QueryWithdrawRecords() *WithdrawRecordQuery {
	query := (&WithdrawRecordClient{config: uq.config}).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := uq.prepareQuery(ctx); err != nil {
			return nil, err
		}
...
// QueryOperateWithdrawRecords chains the current query on the "operate_withdraw_records" edge.
func (uq *UserQuery) QueryOperateWithdrawRecords() *WithdrawRecordQuery {
	query := (&WithdrawRecordClient{config: uq.config}).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := uq.prepareQuery(ctx); err != nil {
			return nil, err
...
// QueryTroubleDeducts chains the current query on the "trouble_deducts" edge.
func (uq *UserQuery) QueryTroubleDeducts() *TroubleDeductQuery {
	query := (&TroubleDeductClient{config: uq.config}).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := uq.prepareQuery(ctx); err != nil {
			return nil, err
		}
...
func (uq *UserQuery) QueryIncomeManages() *IncomeManageQuery {
	query := (&IncomeManageClient{config: uq.config}).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := uq.prepareQuery(ctx); err != nil {
			return nil, err
		}
...
// QueryApproveIncomeManages chains the current query on the "approve_income_manages" edge.
func (uq *UserQuery) QueryApproveIncomeManages() *IncomeManageQuery {
	query := (&IncomeManageClient{config: uq.config}).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := uq.prepareQuery(ctx); err != nil {
			return nil, err
...
func (uq *UserQuery) WithWithdrawRecords(opts ...func(*WithdrawRecordQuery)) *UserQuery {
	query := (&WithdrawRecordClient{config: uq.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	uq.withWithdrawRecords = query
	return uq
}

// WithOperateWithdrawRecords tells the query-builder to eager-load the nodes that are connected to
// the "operate_withdraw_records" edge. The optional arguments are used to configure the query builder of the edge.
func (uq *UserQuery) WithOperateWithdrawRecords(opts ...func(*WithdrawRecordQuery)) *UserQuery {
	query := (&WithdrawRecordClient{config: uq.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	uq.withOperateWithdrawRecords = query
	return uq
}

// WithTroubleDeducts tells the query-builder to eager-load the nodes that are connected to
// the "trouble_deducts" edge. The optional arguments are used to configure the query builder of the edge.
func (uq *UserQuery) WithTroubleDeducts(opts ...func(*TroubleDeductQuery)) *UserQuery {
	query := (&TroubleDeductClient{config: uq.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	uq.withTroubleDeducts = query
	return uq
}
...
func (uq *UserQuery) WithIncomeManages(opts ...func(*IncomeManageQuery)) *UserQuery {
	query := (&IncomeManageClient{config: uq.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	uq.withIncomeManages = query
	return uq
}

// WithApproveIncomeManages tells the query-builder to eager-load the nodes that are connected to
// the "approve_income_manages" edge. The optional arguments are used to configure the query builder of the edge.
func (uq *UserQuery) WithApproveIncomeManages(opts ...func(*IncomeManageQuery)) *UserQuery {
	query := (&IncomeManageClient{config: uq.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	uq.withApproveIncomeManages = query
	return uq
}
...
func (uq *UserQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*User, error) {
	...
	if query := uq.withWithdrawRecords; query != nil {
		if err := uq.loadWithdrawRecords(ctx, query, nodes,
			func(n *User) { n.Edges.WithdrawRecords = []*WithdrawRecord{} },
			func(n *User, e *WithdrawRecord) { n.Edges.WithdrawRecords = append(n.Edges.WithdrawRecords, e) }); err != nil {
			return nil, err
		}
	}
	if query := uq.withOperateWithdrawRecords; query != nil {
		if err := uq.loadOperateWithdrawRecords(ctx, query, nodes,
			func(n *User) { n.Edges.OperateWithdrawRecords = []*WithdrawRecord{} },
			func(n *User, e *WithdrawRecord) {
				n.Edges.OperateWithdrawRecords = append(n.Edges.OperateWithdrawRecords, e)
			}); err != nil {
			return nil, err
		}
	}
	if query := uq.withTroubleDeducts; query != nil {
	...
	if query := uq.withIncomeManages; query != nil {
		if err := uq.loadIncomeManages(ctx, query, nodes,
			func(n *User) { n.Edges.IncomeManages = []*IncomeManage{} },
			func(n *User, e *IncomeManage) { n.Edges.IncomeManages = append(n.Edges.IncomeManages, e) }); err != nil {
			return nil, err
		}
	}
	if query := uq.withApproveIncomeManages; query != nil {
...
func (uq *UserQuery) loadWithdrawRecords(ctx context.Context, query *WithdrawRecordQuery, nodes []*User, init func(*User), assign func(*User, *WithdrawRecord)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[int64]*User)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(withdrawrecord.FieldUserID)
	}
	query.Where(predicate.WithdrawRecord(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(user.WithdrawRecordsColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
...
func (uq *UserQuery) loadOperateWithdrawRecords(ctx context.Context, query *WithdrawRecordQuery, nodes []*User, init func(*User), assign func(*User, *WithdrawRecord)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[int64]*User)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(withdrawrecord.FieldOperateUserID)
	}
	query.Where(predicate.WithdrawRecord(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(user.OperateWithdrawRecordsColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
...
func (uq *UserQuery) loadTroubleDeducts(ctx context.Context, query *TroubleDeductQuery, nodes []*User, init func(*User), assign func(*User, *TroubleDeduct)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[int64]*User)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(troublededuct.FieldUserID)
	}
	query.Where(predicate.TroubleDeduct(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(user.TroubleDeductsColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
...
func (uq *UserQuery) loadIncomeManages(ctx context.Context, query *IncomeManageQuery, nodes []*User, init func(*User), assign func(*User, *IncomeManage)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[int64]*User)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(incomemanage.FieldUserID)
	}
	query.Where(predicate.IncomeManage(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(user.IncomeManagesColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
...
func (uq *UserQuery) loadApproveIncomeManages(ctx context.Context, query *IncomeManageQuery, nodes []*User, init func(*User), assign func(*User, *IncomeManage)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[int64]*User)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(incomemanage.FieldApproveUserID)
	}
	query.Where(predicate.IncomeManage(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(user.ApproveIncomeManagesColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
