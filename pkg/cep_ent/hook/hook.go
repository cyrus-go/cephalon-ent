...
type ClientVersionFunc func(context.Context, *cep_ent.ClientVersionMutation) (cep_ent.Value, error)

// Mutate calls f(ctx, m).
func (f ClientVersionFunc) Mutate(ctx context.Context, m cep_ent.Mutation) (cep_ent.Value, error) {
	if mv, ok := m.(*cep_ent.ClientVersionMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *cep_ent.ClientVersionMutation", m)
}
...
// The DeviceOfflineRecordFunc type is an adapter to allow the use of ordinary
// function as DeviceOfflineRecord mutator.
type DeviceOfflineRecordFunc func(context.Context, *cep_ent.DeviceOfflineRecordMutation) (cep_ent.Value, error)

// Mutate calls f(ctx, m).
func (f DeviceOfflineRecordFunc) Mutate(ctx context.Context, m cep_ent.Mutation) (cep_ent.Value, error) {
	if mv, ok := m.(*cep_ent.DeviceOfflineRecordMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *cep_ent.DeviceOfflineRecordMutation", m)
}
...
// The GiftMissionConfigFunc type is an adapter to allow the use of ordinary
// function as GiftMissionConfig mutator.
type GiftMissionConfigFunc func(context.Context, *cep_ent.GiftMissionConfigMutation) (cep_ent.Value, error)

// Mutate calls f(ctx, m).
func (f GiftMissionConfigFunc) Mutate(ctx context.Context, m cep_ent.Mutation) (cep_ent.Value, error) {
	if mv, ok := m.(*cep_ent.GiftMissionConfigMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *cep_ent.GiftMissionConfigMutation", m)
}
...
// The RechargeCampaignRuleOverseaFunc type is an adapter to allow the use of ordinary
// function as RechargeCampaignRuleOversea mutator.
type RechargeCampaignRuleOverseaFunc func(context.Context, *cep_ent.RechargeCampaignRuleOverseaMutation) (cep_ent.Value, error)

// Mutate calls f(ctx, m).
func (f RechargeCampaignRuleOverseaFunc) Mutate(ctx context.Context, m cep_ent.Mutation) (cep_ent.Value, error) {
	if mv, ok := m.(*cep_ent.RechargeCampaignRuleOverseaMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *cep_ent.RechargeCampaignRuleOverseaMutation", m)
}
