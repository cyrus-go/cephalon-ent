...
const (
	...
	MissionCategoryJPQinglong     MissionCategory = "JP_Qinglong"
	...
	MissionCategoryComfyuiAShuo   MissionCategory = "COMFYUI_A_SHUO"
	MissionCategoryComfyuiJiaMing MissionCategory = "COMFYUI_JIA_MING"
	...
	MissionCategoryLoraFluxGym    MissionCategory = "LORA_FLUX_GYM"
	...
	MissionCategorySDQkk          MissionCategory = "SD_QKK"
...
func (obj MissionCategory) Values() []string {
	return []string{
		...
		string(MissionCategoryJPQinglong),
		...
		string(MissionCategoryComfyuiAShuo),
		string(MissionCategoryComfyuiJiaMing),
		string(MissionCategoryChatchat),
		string(MissionCategoryChatTTS),
		string(MissionCategoryLora),
		string(MissionCategoryLoraFluxGym),
